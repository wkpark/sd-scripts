...
def set_pretrained_model_name_or_path_input(
    ...
    if str(model_list) in SDXL_MODELS:
        ...
        v2 = gr.update(value=False, visible=False)
        v_parameterization = gr.update(value=False, visible=False)
        sdxl = gr.update(value=True, visible=False)
        pretrained_model_name_or_path = gr.update(
            value=str(model_list), visible=False
        )
        pretrained_model_name_or_path_file = gr.update(visible=False)
        pretrained_model_name_or_path_folder = gr.update(visible=False)
        return (
            model_list,
            pretrained_model_name_or_path,
            pretrained_model_name_or_path_file,
    ...
    if str(model_list) in V2_BASE_MODELS:
        ...
        v2 = gr.update(value=True, visible=False)
        v_parameterization = gr.update(value=False, visible=False)
        sdxl = gr.update(value=False, visible=False)
        pretrained_model_name_or_path = gr.update(
            value=str(model_list), visible=False
        )
        pretrained_model_name_or_path_file = gr.update(visible=False)
    ...
    if str(model_list) in V_PARAMETERIZATION_MODELS:
        ...
        v2 = gr.update(value=True, visible=False)
        v_parameterization = gr.update(value=True, visible=False)
        sdxl = gr.update(value=False, visible=False)
        pretrained_model_name_or_path = gr.update(
            value=str(model_list), visible=False
        )
    ...
    if model_list == "custom":
        v2 = gr.update(visible=True)
        v_parameterization = gr.update(visible=True)
        sdxl = gr.update(visible=True)
        pretrained_model_name_or_path = gr.update(visible=True)
        pretrained_model_name_or_path_file = gr.update(visible=True)
        pretrained_model_name_or_path_folder = gr.update(visible=True)
        return (
            model_list,
            pretrained_model_name_or_path,
            pretrained_model_name_or_path_file,
